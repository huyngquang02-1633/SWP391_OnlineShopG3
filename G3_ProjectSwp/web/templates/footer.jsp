                ...
                <div class="tg-threecolumns">
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <div class="tg-footercol">
                            <strong class="tg-logo"><a href="javascript:void(0);"><img src="<%=path%>/images/flogo.png"
                                ...
                                <ul>
                                    <li>
                                        <figure><a href="javascript:void(0);"><img
                                                    src="<%=path%>/images/author/imag-09.jpg" alt="image description"></a>
                                        </figure>
                                    ...
                                    <li>
                                        <figure><a href="javascript:void(0);"><img
                                                    src="<%=path%>/images/author/imag-10.jpg" alt="image description"></a>
                                        </figure>
                                        <div class="tg-authornamebooks">
                                    ...
                                    <li>
                                        <figure><a href="javascript:void(0);"><img
                                                    src="<%=path%>/images/author/imag-11.jpg" alt="image description"></a>
                                        </figure>
                                        <div class="tg-authornamebooks">
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCqlotILg2Zx48SriuyHFo_JJDuG0F5vHA&callback=initMap"></script>
